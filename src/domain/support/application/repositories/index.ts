...
export * from '@/domain/support/application/repositories/ticket-attachments-repository'
export * from '@/domain/support/application/repositories/attachment-repository'
